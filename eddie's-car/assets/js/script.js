...
/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/modal */ "./app/assets/js/modules/modal.js");
/* harmony import */ var _modules_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/slider */ "./app/assets/js/modules/slider.js");
/* harmony import */ var _modules_animation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/animation */ "./app/assets/js/modules/animation.js");
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/form */ "./app/assets/js/modules/form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // console.dir(DescriptionModal);

  /* modal */
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"])('.questions__list-item-link', '.questions__description-modal', '.modal__close', 'open-modal');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_animation__WEBPACK_IMPORTED_MODULE_2__["default"])(); // form

  Object(_modules_form__WEBPACK_IMPORTED_MODULE_3__["formValidation"])('.number-input');
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_3__["removeInputIcon"])();
...
function animation() {
  ...
  var animateOnScroll = function animateOnScroll() {
    animationItems.forEach(function (item, i) {
      var itemHeight = item.offsetHeight,
          ...
          animationStart = 4;
      var itemPoint = window.innerHeight - itemHeight / animationStart;
  ...
  animationItems.length > 0 && window.addEventListener('scroll', animateOnScroll);
...
/*!***************************************!*\
  !*** ./app/assets/js/modules/form.js ***!
  \***************************************/
/*! exports provided: formValidation, findChildNode, removeInputIcon, clearInputs, stateMessage, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formValidation", function() { return formValidation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "findChildNode", function() { return findChildNode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeInputIcon", function() { return removeInputIcon; });
...
var formValidation = function formValidation(inputSelector) {
  var formInputs = document.querySelectorAll(inputSelector);
...
var findChildNode = function findChildNode(parent, tagName) {
...
var removeInputIcon = function removeInputIcon() {
  var formInputs = document.querySelectorAll('input');
  formInputs.forEach(function (input) {
    var parent = input.parentElement;
    var iconParent = findChildNode(parent, 'span');
    input.addEventListener('focus', function () {
      return iconParent.style.visibility = 'hidden';
    });
    input.addEventListener('blur', function () {
      return iconParent.style.visibility = 'visible';
    });
  });
};
...
var getFormData = function getFormData() {
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      postData('./assets/php/server.php', formData).then(function (res) {
...
/*!****************************************!*\
  !*** ./app/assets/js/modules/modal.js ***!
  \****************************************/
/*! exports provided: default, DescriptionModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return modal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DescriptionModal", function() { return DescriptionModal; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
var Modal = /*#__PURE__*/function () {
  function Modal(triggerSelector, modalSelector, activeClass, parentSelector, body) {
  ...
  _createClass(Modal, [{
    ...
    value: function addModal() {
      ...
      modal.classList.add(this.modalSelector);
      modal.insertAdjacentElement('beforeend', this.body);
      this.modal = modal;
    }
  }]);
...
var DescriptionModal = /*#__PURE__*/function (_Modal) {
  _inherits(DescriptionModal, _Modal);

  var _super = _createSuper(DescriptionModal);

  function DescriptionModal(triggerSelector, modalSelector, activeClass, parentSelector, body) {
    _classCallCheck(this, DescriptionModal);

    return _super.call(this, triggerSelector, modalSelector, activeClass, parentSelector, body);
  }

  _createClass(DescriptionModal, [{
    key: "showModalOnHover",
    value: function showModalOnHover() {
...
function modal(triggerSelector, modalSelector, closeSelector, animationClass) {
  var triggers = document.querySelectorAll(triggerSelector);
  var modalBlocks = document.querySelectorAll(modalSelector);

  var hideModal = function hideModal(item) {
  ...
  triggers.forEach(function (trigger) {
    if (document.body.offsetWidth <= 768) {
      trigger.addEventListener('click', function (e) {
        e.preventDefault();
        showModal(trigger.nextElementSibling);
      });
    }
    ...
    trigger.addEventListener('mouseover', function () {
      return showModal(trigger.nextElementSibling);
    });
  });
  modalBlocks.forEach(function (item) {
    item.addEventListener('click', function (e) {
      e.preventDefault();

      if (e.target && e.target === item || e.target.closest(closeSelector)) {
        triggers.forEach(function (trigger) {
          return hideModal(trigger.nextElementSibling);
        });
      }
    });
  });
...
/***/ "./app/assets/js/modules/slider.js":
/*!*****************************************!*\
  !*** ./app/assets/js/modules/slider.js ***!
  \*****************************************/
/*! exports provided: default */
...
export default function slider() {
	...
	slides.forEach(slide => slide.style.margin = `0 ${spaceBetween}px`);
	btns.forEach(btn => btn.addEventListener('click', (e) => e.preventDefault()));

	let slideWidth = slide.offsetWidth;
	let wrapperWidth = wrapper.offsetWidth;
	let scrollWidth = (slideWidth + (spaceBetween * 2)) * slidesToScroll;


	function scrollSlides(speed, pos) {
	...
	function showPrevSlide() {
		...
		scrollSlides(duration, position);
	}
